...
CREATE TABLE IF NOT EXISTS "challenge-options" (
...
CREATE TABLE IF NOT EXISTS "user_progress" (
	...
	"user_image_src" text DEFAULT '/icon.png' NOT NULL,
	"active_course_id" integer,
	"hearts" integer DEFAULT 10 NOT NULL,
	"points" integer DEFAULT 0 NOT NULL
);
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "challenge-options" ADD CONSTRAINT "challenge-options_challenge_id_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "challenge-progress" ADD CONSTRAINT "challenge-progress_challenge_id_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint

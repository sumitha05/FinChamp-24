...
const main = async () => {
    try {
        ...
        await db.insert(schema.challenges).values([
                ...
                {id: 104, lessonId: 40, type: "SELECT", order: 104, question: "You want to save money for your mom's birthday gift. Identify the goal as a short, medium, or long term goal."},

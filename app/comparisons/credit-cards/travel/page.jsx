...
const TCreditCards = () => {
  ...
  const creditCards = [
    ...
    },
    {
      ...
      issuer: "Chase",
      rewards: "Earn 60,000 bonus points after spending $4,000 on purchases in the first 3 months",
      annualFee: "$95",
      image: creditc,
  ...
  return (
   ...
   <div className='header'>
      ...
      <h2 className='cc-heading'>Travel Cards</h2>
